...
public class OntologyReader2 {
	...
	//constants related to the Date classes in the ontology 
	...
	protected String SOURCE = "http://www.semanticweb.org/edeyson/ontologies/2021/Competencias";
	protected String NS = SOURCE + "#";

	public OntologyReader2() throws Exception {
		...
		System.out.println("Read KSA Ontology"); 
		ontology.read( SOURCE, "TTL" );
	 ...
	 */ 
	public OntologyReader2(OntologyReader2 ont)	{ 
	...
	{ 
		...
		{ 
			...
			{ 
				...
				int idx = comment.indexOf("LIBERmenu="); 
				if (idx >= 0) 
				{ 
					String rest = comment.substring(idx + "LIBERmenu=".length()); 
