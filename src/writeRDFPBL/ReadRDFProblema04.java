...
public class ReadRDFProblema04 {
	static final String inputFileName  = "Problema04Competencias.rdf.xml";
	...
	private static void printCompetences(Resource resourceMD) { 
		...
		System.out.println("\n--------------- Competences URI --------------");
		StmtIterator iter = resourceMD.listProperties(LOMC.taskAchievesCompetence);
		while (iter.hasNext()) {
