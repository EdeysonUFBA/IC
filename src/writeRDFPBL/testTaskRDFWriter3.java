...
public class testTaskRDFWriter3 {
    static String lomvoc = "http://ltsc.ieee.org/rdf/lomv1p0/vocabulary#";
	static String resourceURI = "https://eduknow.org/CTRL.md";
	...
	private static Task criaTaskTuringMachineII() {
		...
		task.setTitle("Problema : Controle de tráfego.");
		...
		Knowledge k = new Knowledge("Turing_Machine", "", CCS2012.NS);
		Skill skill = new Skill("Applying");
		KnowledgeSkill ks = new KnowledgeSkill(k, skill);
		ks.setUri("C1KS01");
		c.addKnowledgeSkill(ks);

		k = new Knowledge("Requirements_Analysis_and_Specification", "", CCS2012.NS);
		...
		k = new Knowledge("Turing_Machine", "", CCS2012.NS);
		skill = new Skill("Understanding");
		ks = new KnowledgeSkill(k, skill);
		ks.setUri("C2KS01");		
		c.addKnowledgeSkill(ks);
		...
		k = new Knowledge("Written_Communication", "", CCS2012.NS);
		skill = new Skill("Understanding");
		ks = new KnowledgeSkill(k, skill);
		ks.setUri("C5KS01");		
		c.addKnowledgeSkill(ks);	
