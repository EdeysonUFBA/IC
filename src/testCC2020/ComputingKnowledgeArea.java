...
public class ComputingKnowledgeArea {
	private ArrayList<Knowledge> computingKnowledgeAreas = new ArrayList<Knowledge>();

	public ComputingKnowledgeArea() {
		super();
		defineKnowledgeAreas();		
	}

	public ArrayList<Knowledge> getComputingKnowledgeAreas() {
		return computingKnowledgeAreas;
	}
	...
	private void addComputingKnowledgeAreasNode(Knowledge broader, String entry, String knowledgeName) {
